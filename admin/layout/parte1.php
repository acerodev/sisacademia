...
if(isset($_SESSION['sesion_email'])){
   // echo "el usuarios paso por el login";
    ...
    $conta = strlen($url);
    $rest = substr($url, 13, $conta); //CAMBIAR LA CANTIDAD DE CARACTERES QUE TIENE LA CARPETA EN CASO DE CAMBIAR EL NOMBRE DE LA CARPETA "EJEMPLO: sisgestionescolar = 18" 17 + 1
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="<?=APP_URL;?>/admin" class="brand-link">
            ...
            <img src="https://i.imgur.com/CPNLGbu.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">ACADEMIA PI</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <?php
                    if( ($rol_sesion_usuario=="ADMINISTRADOR") || ($rol_sesion_usuario=="DIRECTOR ADMINISTRATIVO") || ($rol_sesion_usuario=="DIRECTOR ACADÉMICO") || ($rol_sesion_usuario=="CONTADOR") || ($rol_sesion_usuario=="SECRETARIA")){ ?>
                        <li class="nav-item">
                            <a href="#" class="nav-link active">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?=APP_URL;?>/admin/pagos/lista_de_pagos.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Realizar pago</p>
                                    </a>
                                </li>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?=APP_URL;?>/admin/pagos/ListaPagoIlo.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pagos - Ilo</p>
                                    </a>
                                </li>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?=APP_URL;?>/admin/pagos/ListaPagoAlgarrobal.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pagos - Algarrobal</p>
                                    </a>
                                </li>
                            </ul>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?=APP_URL;?>/admin/pagos/ListaPagoPuerto.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pagos - Puerto</p>
                                    </a>
                                </li>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?=APP_URL;?>/admin/pagos/lista_pagostodo.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Lista de pagos - Todo</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
