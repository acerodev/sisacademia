                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?=$id_institucion_persona;?>" name="id_institucion_persona" hidden>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="address" name="direccion_per" value="<?=$direccion_per;?>" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="config_institucion_id" id="" class="form-control">
                                                ...
                                                foreach ($instituciones as $institucione){ ?>
                                                    <option value="<?=$institucione['id_config_institucion'];?>" <?=$institucione['id_config_institucion']==$id_config_institucion ? 'selected' : ''?> ><?=$institucione['nombre_institucion'];?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="grado_id" id="" class="form-control">
                                                ...
                                                foreach ($grados as $grado){ ?>
                                                    <option value="<?=$grado['id_grado'];?>" <?=$grado['id_grado']==$grado_id ? 'selected' : ''?> ><?=$grado['curso']." | Salón ".$grado['paralelo'];?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="modalidad" id="modalidad" class="form-control">
                                                ...
                                                <option value="VIRTUAL"<?php if($modalidad=='VIRTUAL'){ ?> selected="selected" <?php } ?>>VIRTUAL</option>
                                                <option value="HIBRIDO"<?php if($modalidad=='HIBRIDO'){ ?> selected="selected" <?php } ?>>HÍBRIDO</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
