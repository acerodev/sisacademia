                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        foreach ($reportes_estudiantes as $reportes_estudiante){
                           ...
                           if($reportes_estudiante['grado_id']=="16") $contador_preu1 = $contador_preu1 + 1;
                           if($reportes_estudiante['grado_id']=="17") $contador_preu2 = $contador_preu2 + 1;
                        }
                        $datos_reporte_estudiantes = 
                            ...
                            .$contador_preu1.",".$contador_preu2;;
                        ?>
                        <script>
                            var grados = ['Pri - 1', 'Pri - 2', 'Pri - 3', 'Pri - 4','Pri - 5',
                                'Pri - 6','Sec - 1','Sec - 2','Sec - 3','Sec - 4','Sec - 5','Sec - 6','PreU - A','PreU - B'];
