                        ...
                        <div class="card-body">
                            <table class="table table-striped table-bordered table-sm table-hovers">
                                <tr>
                                    ...
                                    <th style="text-align: center;background-color: #0cd0e6">Monto S/.</th>
                                    <th style="text-align: center;background-color: #0cd0e6">F. de Pago</th>
                                    <th style="text-align: center;background-color: #0cd0e6">Pagado</th>
                                    <th style="text-align: center;background-color: #0cd0e6">Metodo</th>
                                    <th style="text-align: center;background-color: #0cd0e6">F. de Inicio</th>
                                    <th style="text-align: center;background-color: #0cd0e6">F. de Termino</th>
                                ...
                                foreach ($pagos as $pago){
                                    ...
                                    <tr>
                                        ...
                                        <td><center>S/. <?=$pago['monto_apagar'];?></center></td>
                                        <td><center><?=$pago['fecha_pagado'];?></center></td>
                                        <td><center>S/. <?=$pago['monto_pagado'];?></center></td>
                                        <td><center><?=$pago['metodo_pago'];?></center></td>
                                        <td><center><?=$pago['fecha_inicio'];?></center></td>
                                        <td><center><?=$pago['fecha_fin'];?></center></td>
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="monto_apagar" class="form-control" value="<?=$pago['monto_apagar'];?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="metodo_pago" id="" class="form-control">
                                                                                    <option value="SIN DEFINIR" <?=$pago['metodo_pago']=="SIN DEFINIR" ? 'selected' : ''?>>SIN DEFINIR</option>
                                                                                    ...
                                                                                    <option value="TRANSFERENCIA BCP" <?=$pago['metodo_pago']=="TRANSFERENCIA BCP" ? 'selected' : ''?>>TRANSFERENCIA BCP</option>
                                                                                    <option value="TRANSFERENCIA INTERBANK" <?=$pago['metodo_pago']=="TRANSFERENCIA INTERBANK" ? 'selected' : ''?>>TRANSFERENCIA INTERBANK</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="date" name="fecha_inicio" value="<?=$pago['fecha_inicio'];?>" class="form-control">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label for="">Fecha de Termino</label>
                                                                                <input type="date" name="fecha_fin" value="<?=$pago['fecha_fin'];?>" class="form-control">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            </div>
                                                ...
                                                <a href="ticket_pago.php?id=<?=$id_pago;?>&&id_estudiante=<?=$estudiante_id;?>" type="button" class="btn btn-warning btn-sm" target="_blank"><i class="bi bi-printer"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php
                ...
                <form action="<?=APP_URL;?>/app/controllers/pagos/create.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Monto S/.</label>
                                <input type="text" name="monto_apagar" class="form-control" value="250">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="">Fecha de Pago</label>
                                <input type="date" name="fecha_pagado" class="form-control" value="<?=$fecha_actual ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="metodo_pago" id="" class="form-control">
                                    ...
                                    <option value="TRANSFERENCIA">TRANSFERENCIA INTERBANK</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
