...
$QR = 'Este contrato es verificado por el sistema de inscripción de la '.$nombre_institucion.', 
...
<tr>
     ...
     <td style="text-align: center"><h2><b><u>CARTADE COMPROMISO PARA ESTUDIANTE DE '.$nivel.'</u></b></h2></td>
</tr>
</table>
...
'.$nombre_institucion.', en adelante denominado "Academia Pre-U", representado por el <b style="color: blue">Ing. Blademir Acero Oliva</b>, con 
domicilio en AA.HH. Villa Primavera Mz28 Lt04. Padres/Tutores legales del estudiante <b style="color: blue">'.$apellidos.' '.$nombres.'</b>, en adelante denominado "El Estudiante", 
...
Matrícula: Los Padres/Tutores legales matriculan al Estudiante en la Academia Pre-U para el año escolar <b style="color: blue">'.$curso.'</b>.
...
y reglamentos establecidos por la Academia Pre-U.
<br><br>
...
maestros y cumplir con las obligaciones financieras relacionadas con la matrícula y las tarifas academicas.

<br><br>

<b>Duración del Contrato: </b>Este compromiso tiene una duración de un mes academico y se renovará automáticamente para cada mes academico subsiguiente, a menos que cualquiera 
de las partes notifique lo contrario con al menos 5 días de antelación al inicio del nuevo mes academico.

<br><br>

<b>Terminación del Contrato:</b> La Academia Pre-U se reserva el derecho de rescindir este contrato si el Estudiante o los Padres/Tutores no cumplen con las normas 
