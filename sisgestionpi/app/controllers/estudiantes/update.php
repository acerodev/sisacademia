...
$id_institucion_persona = $_POST['id_institucion_persona'];
...
$sentencia = $pdo->prepare('UPDATE instituciones_personas
        SET config_institucion_id = :config_institucion_id,
            fyh_actualizacion = :fyh_actualizacion
    WHERE id_institucion_persona = :id_institucion_persona');

//$sentencia->bindParam(':persona_id', $id_persona);
$sentencia->bindParam(':config_institucion_id', $config_institucion_id);
$sentencia->bindParam(':fyh_actualizacion', $fechaHora);
$sentencia->bindParam(':id_institucion_persona', $id_institucion_persona);
