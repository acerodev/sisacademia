...
foreach ($estudiantes as $estudiante){
    ...
    $id_institucion_persona = $estudiante['id_institucion_persona'];
    $id_config_institucion = $estudiante['id_config_institucion'];

    $direccion_inst = $estudiante['nombre_institucion'];
    ...
    $direccion_per = $estudiante['direccion_per'];
